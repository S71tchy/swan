...
from app.routers import admin, alerts, analytics, approvals, auth, meta, notifications, users
...
for r in (auth.router, alerts.router, analytics.router, approvals.router, users.router,
          meta.router, notifications.router, admin.router):
